...
public class BorrowServiceImpl implements BorrowService {
    ...
    public List<BorrowInfo> getAllBorrows() {
        ...
        String sql = " select \n" +
                ...
                "(tbi.receive_corpus + tbi.receive_interest + tbi.overdue_fine )  as repayAmount,\n" +
                " case when 1 > 0  then '是'\n" +
                " else '' end isFinished,\n" +
                " ti.id as billId \n" +
                ...
                "where tb.status = 5 and tb.period_unit = 2  and tb.period > 1     ORDER BY tb.id asc ,ti.id  asc limit 100 ";
